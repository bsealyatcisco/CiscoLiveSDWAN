...
#policy
#stud_egress_policy = ('S%s_EGRESS_QOS' % stud_num)
#stud_rewrite_policy = ('S%s_REWRITE' % stud_num)
#stud_localbranch_policy = ('S%s_LOCAL_BRANCH_2' % stud_num)
#stud_rp_policy = ('S%s_OSPF_V03' % stud_num)
